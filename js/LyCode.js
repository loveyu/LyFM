...
function LyCode(){
	...
	$("#"+LyCode.ID+" .run_code").click(function(){LyCode.prototype.run_code()});
	$("#"+LyCode.ID+" .min").click(function(){LyCode.prototype.min_box()});
	$("#"+LyCode.ID+" .close").click(function(){LyCode.prototype.close_box()});
	$("#"+LyCode.ID+" .clear").click(function(){LyCode.prototype.clear_box()});
	editAreaLoader.init({
			...
			,language: "zh"
			,syntax: "php"
			,EA_load_callback: "LyCode.prototype.edit_load_ok"
...
LyCode.prototype = {
	...
	edit_load_ok:function(){
		 $(window.frames["frame_RUN_CODE_TEXTAREA"].document).keydown(function(){LyCode.prototype.key_down()});
	},
	close_box:function(){
		this.clear_box();
		this.min_box();

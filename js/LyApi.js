...
TextFileExtenName = new Array('txt','htaccess','php','php5','json','xml','asp','html','htm','jsp','java','c','cpp','h','cmd','sh','m','cc','cxx','hxx','hpp','log','ini','cs','inc','pas','phtml','js','jsp','css','sh','bsh','pl','py','rc','vb','vbs','as','asm','f','sql','tex','md','readme','srt','conf');
